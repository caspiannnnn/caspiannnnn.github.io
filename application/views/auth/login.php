...
<head>
    ...
    <style>
        body {
            background: url("<?= base_url('vendor/images/18c17b49a613c2795a2dce04003ca883.jpg') ?>");
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Login Gallery Seni</h5>
