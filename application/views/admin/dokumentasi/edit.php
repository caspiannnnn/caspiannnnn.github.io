            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-3 col-form-label">Nama Seniman</label>
                            <div class="col-sm-9">
                                <input type="text" name="nama_seniman" value="<?= $q['nama_seniman'] ?>" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
